   	...
   	$alert='';
		if(empty($_POST['proveedor']) || empty($_POST['contacto']) || empty($_POST['telefono']) || empty($_POST['direccion']))
		{
			...
			$result = 0;
				...
				if ($sql_update){
					$alert='<p class="msg_save">Proveedor actualizado correctamnete.</p>';
...
<body>
	...
	<section id="container">
		...
		<div class="form_register">
			<h1><i class="far fa-edit"></i></i> Actualizar Proveedor</h1>
			<hr>
			...
			<form action="" method="post">
				...
				<button type="submit" class="btn_save"><i class="far fa-edit"></i> Actulizar Proveedor</button>
			</form>
		</div>
