<?php 
   ...
   if(!empty($_POST))
   {
   	...
   	$alert='';
		if(empty($_POST['proveedor']) || empty($_POST['producto']) || empty($_POST['precio']) || empty($_POST['existencia']) || empty($_POST['id']) || empty($_POST['foto_actual']) || empty($_POST['foto_remove']))
		{
			...
			$query_update = mysqli_query($conection, "UPDATE  producto SET descripcion = '$producto',  proveedor = $proveedor, precio = $precio, existencia =$existencia, foto = '$imgProducto'
				...
				if ($query_update){
					...
					$alert='<p class="msg_save">Producto actualizado correctamnete.</p>';
   ...
   if (empty($_REQUEST['id'])){
   		...
   		$query_producto = mysqli_query($conection,"SELECT p.codproducto,p.descripcion,p.precio,p.existencia,p.foto,pr.codproveedor,pr.proveedor FROM producto p 
	...
	<section id="container">
		...
		<div class="form_register">
			...
			<form action="" method="post" enctype="multipart/form-data">
				...
				placeholder="Precio del producto" value="<?php echo $data_producto['precio']; ?>">
				<label for="existencia">Existencia</label>
				<input type="number" name="existencia" id="existencia"
				placeholder="existencia del Producto" value="<?php echo $data_producto['existencia']; ?>">
				<div class="photo">
					<label for="foto">Foto</label>
        		<div class="prevPhoto">
        			<span class="delPhoto <?php echo$classRemove; ?>">X</span>
        			<label for="foto"></label><?php echo $foto; ?>
        		</div>
        		<div class="upimg">
