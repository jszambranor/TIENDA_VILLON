   ...
   if (!empty($_POST))
   {
   	$alert='';
		if(empty($_POST['nombre']) || empty($_POST['telefono']) || empty($_POST['direccion']))
		{
			...
			if ($result > 0){
				$alert='<p class="msg_error">El nit ya existe, ingrese otra</p>';
			}else{
				...
				if ($sql_update){
					$alert='<p class="msg_save">cliente actualizado correctamnete.</p>';
...
<body>
	...
	<section id="container">
		...
		<div class="form_register">
			<h1><i class="far fa-edit"></i>Actualizar clientes</h1>
			<hr>
